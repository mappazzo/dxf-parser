...
describe('Parser', function() {
  ...
  it('should parse a complex BLOCKS section', function () {
    ...
    try {
      ...
      fs.writeFileSync(path.join(__dirname, 'data', 'blocks.received.txt'), JSON.stringify(dxf, null, 2));
    } catch (err) {
      should.not.exist(err);
    }
    should.exist(dxf);
    ...
    var expected = fs.readFileSync(path.join(__dirname, 'data', 'blocks.approved.txt'), { encoding: 'utf8' });
